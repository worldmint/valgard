                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ValgardCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ValgardCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and valgardcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ValgardCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ValgardCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ValgardCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ValgardCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ValgardCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ValgardCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ValgardCoin Core help message to get a list with possible ValgardCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ValgardCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ValgardCoin network", "", count));
}
...
{
    QString strTitle = tr("ValgardCoin Core"); // default title
