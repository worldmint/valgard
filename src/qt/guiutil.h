...
/** Utility functions used by the ValgardCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ValgardCoin addresses in monospace font
...
// Parse "valgardcoin:" URI into recipient object, return true on successful parsing
