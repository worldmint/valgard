...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ValgardCoin Core"),
     ...
     * override -datadir in the valgardcoin.conf file in the default data directory
     * (to be consistent with valgardcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
