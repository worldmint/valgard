...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Valgardcoin Core valgardcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  valgardcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded valgardcoin transaction") + "\n" +
                               "  valgardcoin-tx [options] -create [commands]   " + _("Create hex-encoded valgardcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded valgardcoin transaction
