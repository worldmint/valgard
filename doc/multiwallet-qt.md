...
In order to support loading of multiple wallets in valgardcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is valgardcoin.cpp.
...
Changes to valgardcoin.cpp
----------------------
valgardcoin.cpp is the entry point into valgardcoin-qt, and as such, will require some minor modifications to provide hooks for
