...
This mechanism has been integrated into Bitcore-Node-ValgardCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ValgardCoin-Project/insight-api-valgardcoin#web-socket-api](https://github.com/ValgardCoin-Project/insight-api-valgardcoin#web-socket-api) 
* API: [https://github.com/ValgardCoin-Project/insight-api-valgardcoin#swifttx-transactions](https://github.com/ValgardCoin-Project/insight-api-valgardcoin#swifttx-transactions) 
...
By default, the ValgardCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ValgardCoin Core daemon:
